        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="bg-white shadow-md">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center w-full">
                    <h2 class="text-2xl font-bold text-gray-800">Gestion des Prestations</h2>
            ...
            <div class="flex-1 overflow-auto p-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-bold text-gray-800">Liste des Prestations</h3>
                    <a href="add.php" class="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition">
                                ...
                                <?php else: ?>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm gap-2 flex">
                                            ...
                                            <a href="delete.php?id=<?php echo $prestation->getNumeroPrest(); ?>" class="inline-flex items-center px-3 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition" onclick="return confirm('Êtes-vous sûr?')">
