    ...
    <div class="flex h-screen bg-gray-900">
        ...
        <div class="w-64 bg-gray-800 text-white shadow-lg">
            ...
            <nav class="mt-6 px-4">
                <ul class="space-y-2">
                    <li>
                        <a href="Dashboard.php" class="flex items-center px-4 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 transition">
                            <i class="fas fa-chart-line mr-3"></i>Dashboard
                        </a>
                    </li>
                    <?php if ($role === 'administrateur'): ?>
                    <li>
                        <a href="pages/utilisateurs/index.php" class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-700 transition">
